...
import { HomeIcon,Heart, Users, Shield, Clock, MapPin, Star, Utensils, Brain, Phone, Mail } from "lucide-react"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-foreground">Memory Care</h2>
              </div>
              <p className="text-lg text-muted-foreground mb-6">
                Specialized care for residents with Alzheimer's disease, dementia, and other memory-related conditions.
                Our trained staff understands the unique challenges and provides compassionate, patient-centered care.
              </p>
            ...
            <div>
              ...
              <img
                src="/elderly-person-doing-memory-activities-with-caregi.png"
                alt="Memory care activities"
              ...
              {[
                {
                  ...
                  description:
                    "Every care plan is tailored to the individual's unique needs, preferences, and life story.",
                },
                {
                  title: "Family Partnership",
                  description: "We work closely with families to ensure continuity of care and open communication.",
                },
                {
                  title: "Holistic Approach",
                  description: "We address physical, emotional, social, and spiritual well-being for complete care.",
                },
      ...
      <section className="py-20 px-4 bg-primary text-primary-foreground">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Schedule a tour to see our services in action and meet our caring team.
          </p>
