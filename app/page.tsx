...
import { Phone, Mail, MapPin, HomeIcon, Heart, Users, Clock, Shield, Star } from "lucide-react"
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 px-4 bg-gradient-to-b from-card to-background">
        ...
        <div className="mt-16 container mx-auto">
          {/* TO REPLACE: Upload your image and change the src path below */}
          <img
            src="/cozy-adult-family-home-interior-with-comfortable-s.png"
            alt="Springs of Joy cozy interior"
            ...
            {[
              {
                ...
                description: "Personalized daily living assistance while maintaining independence and dignity.",
              },
              {
              ...
              },
              {
                ...
                description: "Home-cooked, nutritious meals prepared with love and dietary considerations.",
              },
              {
                icon: <Clock className="h-8 w-8 text-primary" />,
                title: "24/7 Support",
                description: "Round-the-clock trained staff ensuring safety and peace of mind.",
              },
              {
                icon: <MapPin className="h-8 w-8 text-primary" />,
                title: "Transportation",
                description: "Safe transportation to medical appointments and community activities.",
              },
              {
                icon: <Star className="h-8 w-8 text-primary" />,
                title: "Daily Activities",
                description: "Engaging activities and companionship to enrich daily life.",
              },
            ].map((service, index) => (
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                quote:
                  "Springs of Joy truly feels like home. The staff treats my mother with such kindness and respect. I couldn't ask for better care.",
                author: "Sarah M.",
                relation: "Daughter of Resident",
              },
              {
                quote:
                  "The personalized attention and warm environment at Springs of Joy gave our family peace of mind during a difficult time.",
                author: "Michael R.",
                relation: "Son of Resident",
              },
              {
                quote:
                  "Robert and Lucy's compassionate approach to care is evident in everything they do. My father is happy and well-cared for.",
                author: "Jennifer L.",
                relation: "Daughter of Resident",
              },
      ...
      <section className="py-20 px-4 bg-primary text-primary-foreground">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Schedule a tour today and see why families choose us for their loved ones.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
